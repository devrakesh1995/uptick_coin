          ...
          <KeyboardAvoidingView behavior="position">
            <View>
              <View style={{ alignItems: 'center', marginTop: 15 }}>
                <View style={{ backgroundColor: 'red', width: width - 35, borderRadius: 18, elevation: 8, borderWidth: 1, borderColor: '#131313' }}>
                  <View style={{ borderRadius: 17, borderWidth: 1, borderColor: '#C79323' }}>
                    <View style={{ marginTop: 10, }}>
                      <Text style={{ fontSize: 15, color: 'white', marginHorizontal: 20 }}></Text>
