      ...
      <SafeAreaView >
        ...
        <View style={{ width: width, height: '100%', backgroundColor: '#E5E5E5', }}>
          <View style={{ height: '100%', }} >
            ...
            <View style={{ height: 50, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', elevation: 8, backgroundColor: '#233446' }}>
              ...
              <View style={{ flexDirection: 'row', width: '95%', justifyContent: 'space-between', alignItems: 'center' }}>
                <Text style={{ fontSize: 20, marginLeft: 10, color: '#FFF', textShadowOffset: { width: 1, height: 1 }, }}>UpTickCoin</Text>
                <TouchableOpacity onPress={this.toggleModal}
                  style={{ height: 26, width: 26, backgroundColor: '#FFF', borderRadius: 13, alignItems: 'center', justifyContent: 'center', elevation: 8 }}>
            ...
            >
              {
                addressList && addressList.length ? addressList.map((element) => (
                  <View style={{ marginHorizontal: 18 }} key={element.id}>
                    <View style={{ backgroundColor: 'white', width: width - 35, borderRadius: 13, elevation: 5, borderWidth: 1, borderColor: '#233446', marginTop: 20 }}>
                      <View style={{ borderRadius: 12, borderWidth: 1, borderColor: '#233446' }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, alignItems: 'center', marginHorizontal: 15 }}>
                          ...
                          >
                            <View
                              style={{ backgroundColor: '#25437B', height: 20, borderRadius: 5, alignItems: 'center', justifyContent: 'center', elevation: 8 }}>
                              <Text style={{
                                marginHorizontal: 10,
                                textAlign: 'center',
                                color: '#fff',
        ...
        <Modal isVisible={this.state.isShowModal}>
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <View style={{ backgroundColor: '#FFF', width: width - 50, borderRadius: 18, elevation: 8, borderWidth: 1.5, borderColor: '#233446' }}>
              <View style={{ borderRadius: 17, }}>
                ...
                <View style={{ flexDirection: 'row', marginBottom: 30, marginTop: 40, justifyContent: 'space-between', marginHorizontal: 20 }}>
                  ...
                  <View style={{ width: '45%', borderRadius: 10, elevation: 8 }}>
                  ...
                  <View style={{ width: '45%', borderRadius: 10, elevation: 8 }}>
                    <View
                      style={{ backgroundColor: '#25437B', height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#25437B' }}>
                      <TouchableOpacity style={{ width: '100%' }}
        ...
        <Modal isVisible={this.state.isShowSendModal}>
          <View style={{ backgroundColor: '#FFF', width: width - 50, borderRadius: 12, elevation: 8, borderWidth: 1.5, borderColor: '#233446', alignSelf: 'center' }}>
...

              {
                users && !users.sendCoinTXOTPSuccess ?
                  <>
                    <View style={{ marginHorizontal: 18, width: '100%' }}>
                      <View style={{ flexDirection: 'row', marginTop: 10, marginHorizontal: 20, justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text style={{ fontSize: 18, fontWeight: 'normal', textShadowOffset: { width: 1, height: 1 }, }}>
                      ...
                      <View style={{ marginHorizontal: 20, height: 45, backgroundColor: '#E5E5E5', marginTop: 15, borderRadius: 10 }}>
                        <TextInput
                          style={{ marginHorizontal: 10, fontSize: 15 }}
                          placeholder="Amount"
                          name="amount"
                      ...
                      <View style={{ flexDirection: 'row', marginBottom: 30, marginTop: 40, justifyContent: 'space-between', marginHorizontal: 20 }}>
                        ...
                        <View style={{ width: '45%', borderRadius: 10, elevation: 8 }}>
                          <View
                            style={{ backgroundColor: '#000', height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', }}>
                            <TouchableOpacity style={{ width: '100%' }}
                  ...
                  <>
                    ...
                    <View style={{ height: 45, width: width - 100, backgroundColor: '#FFF', marginTop: 15, borderRadius: 10 }}>
                      <TextInput
                        style={{ marginHorizontal: 10, fontSize: 15 }}
                        name="otp"
                    ...
                    <View style={{ width: width - 100, borderRadius: 10, marginHorizontal: 20, marginBottom: 30, marginTop: 40, elevation: 8 }}>
